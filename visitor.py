...
class Visitor():
    ...
    def visitSignatureFunc(self, signatureFunc):
        ...
        signatureFunc.funcparametros.accept(self)
    ...
    def visitExpressaoInt(self, ExpressaoInt):
        print(ExpressaoInt.int)

    def visitExpressaoFloat(self, ExpressaoFloat):
        print(ExpressaoFloat.float)
    ...
    def visitExpressaoCall(self, ExpressaoCall):
        ExpressaoCall.call.accept(self)
    ...
    def visitCompoundListexp(self, listexp):
        listexp.expressao.accept(self)
        print(',')
    ...
    def visitExpressaoNum(self, ExpressaoNum):
        print(ExpressaoNum.num)

    def visitNoAssign(self, NoAssign):
        print(NoAssign.id)

    def visitExpressaoVardecl(self, ExpressaoVarDecl):
        ExpressaoVarDecl.varDecl.accept(self)


# Teste rapido -- so roda executando este arquivo direto.
